...
class State {
 public:
   ...
   */
  State(int n_poses, int n_features);
   ...
   */
  State(const double time, const unsigned int seq, const Vector3& p,
  ...
  [[nodiscard]] unsigned int getSeq() const;

  [[nodiscard]] Vector3 getPosition() const;

  [[nodiscard]] Quaternion getOrientation() const;

  [[nodiscard]] Matrix getPositionArray() const;

  [[nodiscard]] Matrix getOrientationArray() const;

  [[nodiscard]] Matrix getFeatureArray() const;

  [[nodiscard]] Quaternion getOrientationExtrinsics() const;

  [[nodiscard]] Vector3 getPositionExtrinsics() const;
   ...
   */
  [[nodiscard]] Eigen::VectorXd getDynamicStates() const;

  [[nodiscard]] Matrix getCovariance() const;
   ...
   */
  [[nodiscard]] Matrix getPoseCovariance() const;
   ...
   */
  [[nodiscard]] Matrix getDynamicCovariance() const;
   ...
   */
  void setImu(double time, unsigned int seq, const Vector3& w_m,
              const Vector3& a_m);
   ...
   *         {W} into {C}.
   */
  [[nodiscard]] Attitude computeCameraAttitude() const;
   ...
   */
  [[nodiscard]] Vector3 computeCameraPosition() const;
   ...
   *         {W} into {C}.
   */
  [[nodiscard]] Quaternion computeCameraOrientation() const;
 ...
 private:
   ...
   */
  [[nodiscard]] Quaternion errorQuatFromSmallAngles(
      const Vector3& delta_theta) const;
